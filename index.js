import{a as n,S as h,i as c}from"./assets/vendor-CocXUmuy.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const L="https://pixabay.com/api/",b="50197022-5c303e37ac1e7741936867a9a";n.defaults.baseURL=L;n.defaults.params={key:b,image_type:"photo",orientation:"horizontal",safesearch:!0};async function v(s){return(await n.get("",{params:{q:s}})).data.hits}const w=new h(".gallery a",{captionsData:"alt",captionDelay:200});function S(s,a){const r=s.map(({webformatURL:l,largeImageURL:e,type:t,tags:i,likes:p,views:f,comments:y,downloads:g})=>`<li class="gallery-item js-gallery-item">
